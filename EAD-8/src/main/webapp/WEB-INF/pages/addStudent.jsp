...
<body>
	...
	<div class="container ">
		...
		<form:form modelAttribute="studentCommand">
			...
			<div class="form-group">
				<form:label path="sClass">Class:</form:label>
				<form:input path="sClass" class="form-control" id="class" max="12" min="1" placeholder="Enter your class"  />
				<form:errors cssClass="error text-warning" path="sClass"/> 
			</div>
